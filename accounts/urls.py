...
from .views import registeruser, register, registerplaces, custom_login, user_profile, places_profile, logout_view, create_post, home, homeplaces
app_name = 'accounts'
...
urlpatterns = [
    ...
    path('homeplaces/', homeplaces, name='homeplaces'),
